...
//   const courses = [
//     { id: 1, name: 'React Basics', purchaseDate: '2023-09-01', tutorName: 'John Doe', progress: 75 },
//     { id: 2, name: 'Advanced JavaScript', purchaseDate: '2023-10-15', tutorName: 'Jane Smith', progress: 50 },
//     // Add more courses as needed
//   ];
//  const {currentStudent,status,error}=useSelector(state=>state.students)
...
//           <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: `${params.value}%` }}></div>
//         </div>
//       ),
//     },
//   ];
...
//                 <CardContent>
//                   <Typography variant="h6">Total Courses Purchased</Typography>
//                   <Typography variant="h4">{courses.length}</Typography>
//                 </CardContent>
//               </Card>
//               <Card className="bg-white shadow-md">
//                 <CardContent>
//                   <Typography variant="h6">Total Quizzes Passed</Typography>
...
//                 <Avatar src={user.profilePic} className="w-20 h-20" />
//                 <div>
