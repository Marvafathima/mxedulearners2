...
//   return (
//     <div className="bg-white shadow-md rounded-lg overflow-hidden relative group h-[400px]">
//       <img   
//         src={thumbnailURL} 
//         alt={course.name} 
...
//         <button className="flex-grow bg-purple-900 text-white px-4 py-2 mr-1 rounded">View Details</button>
